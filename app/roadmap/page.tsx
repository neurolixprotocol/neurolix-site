...
const phases = [
  ...
  },
  {
    ...
    status: "current",
   items: [
  "- NeurolixGateway.sol v1.0 — USDC to CCC conversion and take rate routing 
  (8/4/88) — code generated, compile-clean under solc 0.8.20 + 
  optimizer-runs=200, 221 SLOC, awaiting cross-LLM adversarial review 
  on 7 candidate areas",
